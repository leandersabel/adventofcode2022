...
def main():
    with open('input') as input_observations:
        ...
        print('Monkey business:', inspect_scores[0] * inspect_scores[1])
...
class Monkey:
    ...
    def inspect_inventory(self):
        while len(self.items) > 0:
            ...
            # Thus, 9699690 maintains the result of the mod for each monkey
            # while keeping the size of the item scores managebale
            new = eval(self.operation) % 9699690
            if new % self.test == 0:
